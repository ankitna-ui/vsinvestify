        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
          <Link className="md:col-span-2 lg:col-span-2 group relative overflow-hidden bg-surface-container-low rounded-[2rem] p-8 md:p-10 hover:scale-[1.01] transition-all" to="/equity">
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div>
                <div className="w-12 h-12 md:w-14 md:h-14 bg-[#001f66] rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg">
                  <span className="material-symbols-outlined text-2xl md:text-3xl">analytics</span>
                </div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#001f66] mb-4">Equity & Stocks</h3>
              ...
              <div className="mt-8 flex items-center text-[#001f66] font-bold gap-2">
          ...
          <Link className="bg-slate-50 rounded-[2rem] p-8 md:p-10 group hover:bg-[#001f66] transition-all duration-300" to="/mutual-funds">
            <div className="w-12 h-12 md:w-14 md:h-14 bg-white rounded-2xl flex items-center justify-center text-[#001f66] mb-6 shadow-sm">
              <span className="material-symbols-outlined text-2xl md:text-3xl">account_balance_wallet</span>
            </div>
            <h3 className="text-xl md:text-2xl font-bold text-[#001f66] group-hover:text-white mb-4">Mutual Funds</h3>
            ...
            <div className="flex items-center text-[#001f66] group-hover:text-white font-bold gap-2">
          ...
          <Link className="bg-white rounded-[2rem] p-8 md:p-10 border border-slate-100 group shadow-sm hover:shadow-xl transition-all" to="/derivatives">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-[#001f66] mb-4">Derivatives</h3>
            <p className="text-slate-500 mb-6 text-sm">Hedge and trade with sophisticated F&O strategies.</p>
            <div className="flex items-center text-[#001f66] font-bold gap-2">
          ...
          <Link className="bg-amber-50 rounded-[2rem] p-8 md:p-10 group hover:bg-amber-100 transition-all" to="/commodity">
            <div className="w-12 h-12 md:w-14 md:h-14 bg-white rounded-2xl flex items-center justify-center text-amber-600 mb-6">
              <span className="material-symbols-outlined text-2xl md:text-3xl">grid_goldenratio</span>
            </div>
            <h3 className="text-xl md:text-2xl font-bold text-[#001f66] mb-4">Commodity</h3>
            <p className="text-slate-500 mb-6 text-sm">Trade Gold, Silver, and Energy assets securely.</p>
            <div className="flex items-center text-[#001f66] font-bold gap-2">
              Trade MCX <span className="material-symbols-outlined group-hover:translate-x-2 transition-transform">arrow_forward</span>
            </div>
          </Link>
          ...
          <Link className="bg-purple-50 rounded-[2rem] p-8 md:p-10 group hover:bg-purple-100 transition-all" to="/ipo">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-[#001f66] mb-4">IPO Center</h3>
            <p className="text-slate-500 mb-6 text-sm">Apply for upcoming public offerings in one click.</p>
            <div className="flex items-center text-[#001f66] font-bold gap-2">
              Apply Now <span className="material-symbols-outlined group-hover:translate-x-2 transition-transform">arrow_forward</span>
            </div>
          </Link>
          ...
          <Link className="md:col-span-2 lg:col-span-2 bg-[#002d0d] text-white rounded-[2rem] p-8 md:p-10 relative overflow-hidden group" to="/unlisted">
            ...
            <div className="absolute -right-10 -bottom-10 opacity-20 hidden sm:block">
              <span className="material-symbols-outlined text-[12rem] text-white">token</span>
            </div>
          </Link>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 px-6 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex-1 bg-surface-container-low p-8 rounded-[2rem] border border-outline-variant/5 hover:bg-white hover:shadow-xl transition-all duration-500 hover:-translate-x-2 cursor-default group">
              <div className="flex items-center gap-4">
